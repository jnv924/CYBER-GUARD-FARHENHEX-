...
var scenarios = [
  ...
  {
    hackerCard : {
      description : "Hey! you won the lottery of 2000$,to claim the won amount sms to 01xxxxx and give the details .",
      power : 2,
    },
    playerCards : [
      {
        description : "I will willingly accept and give the details which will be asked.",
        power : 0,
      },
      {
        description : "I will block the message and report it as a scam.",
        power : 3,
      },
      {
        description : "I will try to verify the message and send the details.",
        power : 2,
      }
    ]
  },
  {
    hackerCard : {
      description : "A pop-up on your computer says your system is infected and you need to download software to fix it.What you do?",
      power : 2,
    },
    playerCards : [
      {
        description : "I downloaded the software immediately to protect my computer.",
        power : 1,
      },
      {
        description : "I closed the pop-up and ran a scan with my trusted antivirus software.",
        power : 4,
      },
      {
        description : "I ignored the pop-up because it looked suspicious.",
        power : 2,
      }
    ]
  },
  {
    hackerCard : {
      description : "You receive an email with an attachment from an unknown sender.What you do?",
      power : 3,
    },
    playerCards : [
      {
        description : "I opened the attachment to see what it was.",
        power : 1,
      },
      {
        description : "I deleted the email without opening the attachment.",
        power : 4,
      },
      {
        description : "I forwarded the email to IT for further inspection.",
        power : 3,
      }
    ]
  }
